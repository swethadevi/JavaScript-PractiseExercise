...
var newjsonStr = jsonStr.articles;

for (var i = 0, len = newjsonStr.length; i < len; i++) {
   delete newjsonStr[i].url;
   delete newjsonStr[i].urlToImage;
   delete newjsonStr[i].publishedAt;
}
